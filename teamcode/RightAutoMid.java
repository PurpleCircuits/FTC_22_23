...
public class RightAutoMid extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //Did 5 up earlier
        slideAction(22, -.5);
        goToPosition(-12*COUNTS_PER_INCH,33*COUNTS_PER_INCH,.5,0,1*COUNTS_PER_INCH);
        slideAction(-3, -.5);
        sleep(500);
        purpleOps.clawOpen();
        sleep(500);
        ...
        if(position == RIGHT){
            ...
            goToPosition(-26*COUNTS_PER_INCH,26*COUNTS_PER_INCH,.75,0,2*COUNTS_PER_INCH);
            goToPosition(-26*COUNTS_PER_INCH,36*COUNTS_PER_INCH,.75,0,3*COUNTS_PER_INCH);
        }
