...
public class OdometryGlobalCoordinatePosition implements Runnable{
     ...
     */
    public OdometryGlobalCoordinatePosition(DcMotor verticalEncoderLeft, DcMotor verticalEncoderRight, DcMotor horizontalEncoder, double countsPerInch, int threadSleepDelay){
